...
import (
	"context" // Keep errors import if group package uses it
	"flag"
	"fmt" // For clearInputBuffer
	"log"
	"os"
	"os/signal"
	"strings"
	...
	peer "github.com/rson9/KamaCache-Go/peer"
	"github.com/rson9/KamaCache-Go/server"
	"github.com/rson9/KamaCache-Go/utils"
	// Assuming your gRPC proto definitions and client are here
)
...
var (
	...
	// Remote Get Timeout for group's internal peer interaction
	flagRemoteGetTimeout = flag.Duration("remote.get.timeout", 3*time.Second, "远程节点Get请求的超时时间")
)
